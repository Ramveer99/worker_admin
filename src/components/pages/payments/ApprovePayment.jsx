...
function ApprovePayment() {
    ...
    const [initialValues, setInitialValues] = useState({ id: id, approval_file: '' });
    const navigate = useNavigate()

    const validate = values => {
        const errors = {};

        if (!values.approval_file) {
            errors.approval_file = 'Please choose approval file';
        }
        return errors;
    };
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                ...
                formData.append("employeecv", values.approval_file)
                let res = await axios.post(`admin/approve-payment`, formData)
