...
function Edit() {
    ...
    const experienceDetail = useCallback(async () => {
        try {
            setLoading(true);
            let res = await axios.get(`admin/responsibility?id=${id}`)
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                let res = await axios.post(`admin/responsibilityupdate/${values.id}`, { title: values.title })
    ...
    return (
        <>
            <Helmet>
                <title>Edit Responsibility</title>
            </Helmet>
                            ...
                            <div className="card my-4">
                                <div className="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                    <div className="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                        <h6 className="text-white text-capitalize ps-3">Edit Responsibility</h6>
                                    </div>
                                </div>
