...
function List() {
    ...
    const [deleteModelMessage, setDeleteModelMessage] = useState('Are you sure want to delete this page?');
    ...
    const submitDelete = async () => {
        ...
        try {
            let res = await axios.delete(`admin/pages/delete/${idBeingDeleting}`)
    ...
    const handleDeleteConfirm = (row, type) => {
        ...
        setDeleteModelMessage(`Are you sure want to ${type} this page?`)
    ...
    const getPagesList = useCallback(async () => {
        try {
            setLoading(true);
            let res = await axios.get(`admin/pages/list?page=${pageNumber}&keyword=${searchKeyWord}&per_page=${perPage}&sort_by=${sortField}&sort_order=${sortDirection}`)
            setSkillData(res.data.result.pages_data)
