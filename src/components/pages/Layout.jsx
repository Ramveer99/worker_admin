...

{
...

                        {
                            (userData && userData.subadmin_data && userData.subadmin_data.user_access) || (userData && !userData.subadmin_data) ? (
                                <li className="nav-item">
                                    <a href='/admin/commentes' className={`nav-link text-white ${location.pathname.includes('/commentes') ? "active bg-gradient-primary" : ""}`}>
                                        <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
                                            <i className="fa fa-comment-o"></i>
                                        </div>
                                        <span className="nav-link-text ms-1">Comment Management</span>
                                    </a>
                                </li>
                            ) : ''
                        }
