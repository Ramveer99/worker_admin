...
function List() {
    ...
    const submitDelete = async () => {
        ...
        try {
            let res = await axios.delete(`admin/jobtitledel/${idBeingDeleting}`)
    ...
    const handleDeleteConfirm = (row, type) => {
        ...
        setDeleteModelMessage(`Are you sure want to ${type} this jobtitle?`)
    ...
    const getCategoryList = useCallback(async () => {
        try {
            setLoading(true);
            let res = await axios.get(`admin/jobtitllist?page=${pageNumber}&keyword=${searchKeyWord}&per_page=${perPage}&sort_by=${sortField}&sort_order=${sortDirection}`)
                        ...
                        <div className="card my-4">
                            <div className="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div className="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                    <h6 className="text-white text-capitalize ps-3 custom-card-heading">Job Titles</h6>
